function [results] = main_ROIAnalysis(inputFileName, filePath, outputPath, startFrame, endFrame, roiLocs, positionBmode, position)
...
for n = startFrame:endFrame
    ...
    SWEImgBlock = replaceNonEValues(imShapeSelected);%imgDiff);%
